    ...
    try {
      ...
      const responses = await Promise.all(
        endpoints.map((endpoint) =>
          fetch(`${BASE_URL}/api/analytics/${endpoint}`).then((res) =>
            res.json()
          )
        )
      );
          ...
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <MiniCard title="Total Clicks" data={data.overview.total_click} />
                <MiniCard title="Qr Clicks" data={data.overview.total_use_qr} />
                <MiniCard title="Link Clicks" data={data.overview.total_use_link} />
                <MiniCard title="Unique Visitors" data={data.overview.unique_user} />
              </div>
